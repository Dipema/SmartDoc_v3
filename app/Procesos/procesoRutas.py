...
from app.Procesos.procesoModelo import Proceso
#   Servicios. Del componente procesoSvosBD.py importa la clase ProcesosSvos
from app.Procesos.procesoSvosBD import ProcesosSvos
...
def listaProcesos_v1():
    ...
    try: 
        ...
        tuplaConsultaDatos = ProcesosSvos.lista_procesos(numVersion)
...
def altaProceso_v1():
    ...
    try: 
        ...
        tuplaAltaDatos = ProcesosSvos.alta_proceso(_proceso, numVersion)
...
def consultaProceso_v1():
    ...
    try: 
        ...
        tuplaConsultaDatos = ProcesosSvos.consulta_proceso(_proceso, numVersion)
...
def actualizaProceso_v1():
    ...
    try: 
        ...
        # Llamamos al metodo alta_proceso de la clase ProcesosSvos
        tuplaAltaDatos = ProcesosSvos.actualiza_proceso(_proceso, numVersion)
