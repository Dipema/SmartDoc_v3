...
class ProcesosSvos():
    @classmethod
    def lista_procesos(cls, arg_current_app):
        try:
            datosRespuesta = {
                'error': False, 
                'mensaje': ''
    ...
    @classmethod
    def alta_proceso(cls, _Proceso, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
    ...
    @classmethod
    def consulta_proceso(cls, _Proceso, arg_current_app):
        try:
            datosRespuesta = {
                'datos': '',
                'error': False, 
    ...
    @classmethod
    def actualiza_proceso(cls, _Proceso, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
