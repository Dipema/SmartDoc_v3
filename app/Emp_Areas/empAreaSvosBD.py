...
class EmpresaAreaSvos():
    @classmethod
    def lista_empresaAreas(cls, arg_current_app):
        try:
            datosRespuesta = {
                'error': False, 
                'mensaje': ''
    ...
    @classmethod
    def alta_empresaArea(cls, _EmpresaArea, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
            cursor = connection.cursor()
    ...
    @classmethod
    def consulta_empresaArea(cls, _EmpresaArea, arg_current_app):
        try:
            datosRespuesta = {
                'datos': '',
                'error': False, 
    ...
    @classmethod
    def actualiza_empresaArea(cls, _EmpresaArea, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
