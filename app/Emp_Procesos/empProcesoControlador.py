...
from app.Emp_Procesos.empProcesoModelo import Empresa_Procesos

#   Servicios. Del componente empProcesoSvosBD.py importar la clase EmpresaProcesoSvos
from app.Emp_Procesos.empProcesoSvosBD import EmpresaProcesoSvos
...
def listaEmpresaProcesos(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaProcesoSvos.lista_empresaProcesos(_Empresa_Proceso, numVersion)
...
def altaEmpresaProceso(numVersion):
    ...
    try: 
        ...
        tuplaAltaDatos = EmpresaProcesoSvos.alta_empresaProceso(_Empresa_Proceso, numVersion)
...
def consultaEmpresaProceso(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaProcesoSvos.consulta_empresaProceso(_Empresa_Proceso, numVersion)
...
def actualizaEmpresaProceso(numVersion):
    ...
    try: 
        ...
        tuplaAltaDatos = EmpresaProcesoSvos.actualiza_EmpresaProceso(_Empresa_Proceso, numVersion)
