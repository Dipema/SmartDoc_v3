...
def tokenUsuario_v1():
    try:
        ...
        if (errorData):
            ...
            tuplaDEF = BitacoraSvos.alta_bitacora(current_app, _bitacora)
            return (resp, 200)
        ...
        tuplaAutenticaUsuario = UsuarioSvos.autentica_usuario(current_app, _user, False, argVigencia)
