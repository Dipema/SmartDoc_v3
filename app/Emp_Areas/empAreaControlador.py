...
from app.Emp_Areas.empAreaModelo import Empresa_Areas
#   Servicios. Del componente empAreaSvosBD.py importar la clase EmpresaAreaSvos
from app.Emp_Areas.empAreaSvosBD import EmpresaAreaSvos
...
def listaEmpresaAreas(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaAreaSvos.lista_empresaAreas(numVersion)
...
def altaEmpresaArea(numVersion):
    ...
    try: 
        ...
        tuplaAltaDatos = EmpresaAreaSvos.alta_empresaArea(_Empresa_Area, numVersion)
...
def consultaEmpresaArea(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaAreaSvos.consulta_empresaArea(_Empresa_Area, numVersion)
...
def actualizaEmpresaArea(numVersion):
    ...
    try: 
        ...
        # Llamamos al metodo consulta_tdocumento de la clase EmpresaAreaSvosBD, que realiza la consulta del tipo de documento del ID
        tuplaAltaDatos = EmpresaAreaSvos.actualiza_empresaArea(_Empresa_Area, numVersion)
