...
class EmpresaProcesoSvos():
    @classmethod
    def lista_empresaProcesos(cls, _EmpresaProceso, arg_current_app):
        try:
            datosRespuesta = {
                'error': False, 
                'mensaje': ''
    ...
    @classmethod
    def alta_empresaProceso(cls, _EmpresaProceso, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
            cursor = connection.cursor()
    ...
    @classmethod
    def consulta_empresaProceso(cls, _EmpresaProceso, arg_current_app):
        try:
            datosRespuesta = {
                'datos': '',
                'error': False, 
    ...
    @classmethod
    def actualiza_EmpresaProceso(cls, _EmpresaProceso, arg_current_app):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = PostgresBase(arg_current_app)
