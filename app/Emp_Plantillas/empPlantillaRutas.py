from . import bp_empresa_plantilla
...
from app.Emp_Plantillas.empPlantillaControlador import actualizaEmpresaPlantilla, altaEmpresaPlantilla, consultaEmpresaPlantilla, listaEmpresaPlantillas 
