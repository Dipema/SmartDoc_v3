...
#   MODELOS. Obtenemos de los componentes que estan en el directorio Modelos las clases a utilizar
from src.Documentos.documentoModelo import Documento, Expediente_Documento
#   MODELOS. Obtenemos de los componentes que estan en el directorio Modelos las clases a utilizar
...
from src.Documentos.documentoSvosBD import DocumentoSvos
...
def alta_documento_v1():
    ...
    try:
        ...
        altaGS = DocumentoSvos.alta_bucket_GS(current_app, gs_json)
        ...
        altaRedis = DocumentoSvos.alta_documento_redis(current_app.config, redis_json)
        ...
        altaPostgres = DocumentoSvos.alta_documento_supabase(current_app.config, post_json)
...
def consulta_ocr_v1():
    ...
    try:
        ...
        tuplaConsultaDatos = DocumentoSvos.consulta_ocr_redis(current_app.config, query)
