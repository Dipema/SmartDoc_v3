...
from app.Usuario.usuarioSvosBD import UsuarioSvos
...
def altaUsuario_v1():
    ...
    try:
        ...
        tuplaAltaUsuario = UsuarioSvos.alta_usuario(_user)
...
def validaUsuario_v1():
    try:
        ...
        tuplaAutenticaUsuario = UsuarioSvos.valida_usuario(numVersion, _user, argValidaPass, argVigencia)
...
def listaUsuarios_v1():
    ...
    try: 
        ...
        tuplaConsultaDatos = UsuarioSvos.lista_usuarios(numVersion)
