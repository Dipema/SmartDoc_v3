...
from app.Emp_Plantillas.empPlantillaModelo import Empresa_PlantillaDocto

#   Servicios. Del componente empPlantillaSvosBD.py importar la clase EmpresaPlantillaSvos
from app.Emp_Plantillas.empPlantillaSvosBD import EmpresaPlantillaSvos
...
def listaEmpresaPlantillas(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaPlantillaSvos.lista_empPlantillaDoctos(_Empresa_PlantillaDocto, numVersion)
...
def altaEmpresaPlantilla(numVersion):
    ...
    try: 
        ...
        tuplaAltaDatos = EmpresaPlantillaSvos.alta_empPlantillaDocto(_Empresa_PlantillaDocto, numVersion)
...
def consultaEmpresaPlantilla(numVersion):
    ...
    try: 
        ...
        tuplaConsultaDatos = EmpresaPlantillaSvos.consulta_empPlantillaDocto(_Empresa_PlantillaDocto, numVersion)
...
def actualizaEmpresaPlantilla(numVersion):
    ...
    try: 
        ...
        tuplaAltaDatos = EmpresaPlantillaSvos.actualiza_empPlantillaDocto(_Empresa_PlantillaDocto, numVersion)
