...
class EmpresaPlantillaSvos():
    @classmethod
    def lista_empPlantillaDoctos(cls, _empresaPlantilla, argNumVersion, arg_current_app):
        try:
            datosRespuesta = {
                'error': False, 
                'mensaje': ''
    ...
    @classmethod
    def alta_empPlantillaDocto(cls, _empresaPlantilla, argNumVersion):
        try:
            # Conexion a la BBDD (Postgres)    
    ...
    @classmethod
    def consulta_empPlantillaDocto(cls, _empresaPlantilla, argNumVersion):
        try:
            datosRespuesta = {
                'datos': '',
                'error': False, 
    ...
    @classmethod
    def actualiza_empPlantillaDocto(cls, _empresaPlantilla, argNumVersion):
        try:
            # Conexion a la BBDD (Postgres)    
            connection = conexionBD()
